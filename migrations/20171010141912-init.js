...
module.exports = {
  up: (queryInterface, DataTypes) => {
    ...
    })).then(() => queryInterface.createTable('claims', {
      id: {
        type: DataTypes.TEXT,
        primaryKey: true,
      },
    ...
    })).then(() => queryInterface.createTable('claim_revs', {
      id: {
        type: DataTypes.TEXT,
        primaryKey: true,
      },
    ...
    })).then(() => queryInterface.createTable('source_revs', {
      id: {
        type: DataTypes.TEXT,
        primaryKey: true,
      },
    ...
    })).then(() => queryInterface.createTable('points', {
      id: {
        type: DataTypes.TEXT,
        primaryKey: true,
      },
    ...
    })).then(() => queryInterface.createTable('stars', {
      id: {
        type: DataTypes.INTEGER,
        primaryKey: true,
        autoIncrement: true,
