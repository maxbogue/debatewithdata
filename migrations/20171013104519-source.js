...
module.exports = {
  up: (queryInterface, DataTypes) => {
    return queryInterface
      .addColumn('source_revs', 'type', {
        type: DataTypes.TEXT,
      })
      .then(() =>
        queryInterface.addColumn('source_revs', 'institution', {
          type: DataTypes.TEXT,
        })
      )
      .then(() =>
        queryInterface.addColumn('source_revs', 'publication', {
          type: DataTypes.TEXT,
        })
      )
      .then(() =>
        queryInterface.addColumn('source_revs', 'first_hand', {
