<template>
  <div>
    ...
    <div :class="$style.metadata">
      ...
      >
        <div>
          <strong>Research by:</strong> <span v-html="institutionDiff"></span>
        </div>
        <div>
          <strong>Published in:</strong> <span v-html="publicationDiff"></span>
        </div>
      </template>
      <template v-else>
    ...
    <source-chart
      v-if="safeCurr.chart && !safePrev.chart"
