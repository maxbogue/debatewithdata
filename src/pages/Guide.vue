...
<div class="narrow" :class="$style.guide">
  ...
  <p>
    ...
    origin of the data the source is, the better. Data objects can also contain
    a table of raw data and generate basic graphs from that data. Different
    types of data can have different metadata fields.
  </p>
  <h3>Guidelines</h3>
  <ol>
    <li>
    ...
    <li>
      ...
      individual claims and points and added that way instead of offloading the
      discussion via a link.
    </li>
    <li>
  ...
  <ol>
    ...
    <li>
      Key claims should be the claims that represent the different sides of the
      topic's debate most effectively.
    </li>
  </ol>
  ...
  <p>
    Watching an item indicates that you want to be notified when it is changed.
    Starring an item will also watch it by default, but un-watching an item
    does not also un-star it.
  </p>
